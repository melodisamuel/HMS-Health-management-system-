...
router.route('/update-patient/:userId').patch(authController.protect, authController.restrictTo('admin', 'recptionist', 'doctor'), receptionistController.updatePatient);
